...
class Pokemon extends React.Component<PokemonProps> {
...
interface PokemonListState {
  page_num: number;
  pokemon_list: null | PokemonListData[];
}

const PAGE_SIZE = 50;
export default class PokeList extends React.Component<{}, PokemonListState> {
  ...
  componentDidUpdate(prevProps: PokemonListState, prevState: PokemonListState) {
